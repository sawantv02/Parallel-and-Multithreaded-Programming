...
public class Simulation {
	...
	public static Queue<Customer> presentCapacity=new LinkedList<Customer>();
	public static HashMap<Customer, Boolean> ordersDone= new HashMap<Customer, Boolean>();

        public static Machine m1;
        public static Machine m2;
        public static Machine m3;
...
//                Food Coffee=new Food("Coffee",100);
            // Start up machines
                 m1 = new Machine("BurgerMachine",FoodType.burger,machineCapacity);
                 m2=new Machine("FriesMachine",FoodType.fries,machineCapacity);
                 m3=new Machine("CoffeeMachine",FoodType.coffee,machineCapacity);
                logEvent(SimulationEvent.machineStarting(m1,FoodType.burger,machineCapacity));

                logEvent(SimulationEvent.machineStarting(m2,FoodType.fries,machineCapacity));

                logEvent(SimulationEvent.machineStarting(m3,FoodType.coffee,machineCapacity));
		...
		// Shut down machines
                ...
                Simulation.logEvent(SimulationEvent.machineEnding(m1));
                Simulation.logEvent(SimulationEvent.machineEnding(m2));
                Simulation.logEvent(SimulationEvent.machineEnding(m3));
